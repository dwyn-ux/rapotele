...
return [
    ...
    'env' => (string)config_env('APP_ENV', 'production'),
    ...
    'db' => [
        'driver' => (string)config_env('DB_DRIVER', 'mysql'),
    ...
    'telegram' => [
        'bot_token' => (string)config_env('TELEGRAM_BOT_TOKEN', 'isi_token_bot_telegram'),
        'webhook_secret' => (string)config_env('TELEGRAM_WEBHOOK_SECRET', 'isi_random_secret_opsional'),
    ],

    'schedule_reminder' => [
        'secret' => (string)config_env('SCHEDULE_REMINDER_SECRET', 'isi_random_secret_reminder'),
