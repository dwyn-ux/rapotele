...
ALTER TABLE classes ADD COLUMN level VARCHAR(16) NULL;
ALTER TABLE classes ADD COLUMN school_id INT UNSIGNED NULL;
...
ALTER TABLE subjects ADD COLUMN level VARCHAR(64) NULL;
